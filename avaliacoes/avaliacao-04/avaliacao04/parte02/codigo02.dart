...
void main() async {
  ...
  final aluno2 = Aluno(nome: 'Anderson Maia Santos', dataNascimento: '2007-06-06');
  final aluno3 = Aluno(nome: 'Sure Rocha Bezerra', dataNascimento: '2007-12-29');
  ...
  print("\n Olá! Nossos nomes são Anderson Maia Santos e Sure Rocha Bezerra!");
}